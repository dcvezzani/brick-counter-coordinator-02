...
- Parent work item: [GitHub issue #1](https://github.com/dcvezzani/brick-counter-coordinator-02/issues/1) links to `docs/feature/00-shipped/initial-setup/`.
...
| Date | Decision |
|------|----------|
| 2026-06-12 | Feature slug: `initial-setup`. Parent issue #1 created with link to `docs/feature/00-shipped/initial-setup/`. |
