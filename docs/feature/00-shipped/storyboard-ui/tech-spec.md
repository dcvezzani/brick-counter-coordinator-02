...
| Artifact | Relevance |
|----------|-----------|
| [docs/feature/00-shipped/initial-setup/tech-spec.md](../initial-setup/tech-spec.md) | Delivered scaffold: Vue 3, Router, Vitest, shadcn-vue toolchain, `views/` pattern |
...
- Feature branch `docs/feature/00-shipped/storyboard-ui` → PR to `main`; no deploy.
...
- [docs/feature/00-shipped/initial-setup/tech-spec.md](../initial-setup/tech-spec.md)
