...
- Parent work item links to `docs/feature/00-shipped/storyboard-ui/`.
...
| 2026-06-12 | Parent issue [#3](https://github.com/dcvezzani/brick-counter-coordinator-02/issues/3) created with link to `docs/feature/00-shipped/storyboard-ui/`. |
...
- Prior feature: [docs/feature/00-shipped/initial-setup/product-spec.md](../initial-setup/product-spec.md)
