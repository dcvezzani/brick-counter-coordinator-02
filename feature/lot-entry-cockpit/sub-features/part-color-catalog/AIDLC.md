...
| **Product Spec** | [feature/lot-entry-cockpit/sub-features/part-color-catalog/product-spec.md](feature/lot-entry-cockpit/sub-features/part-color-catalog/product-spec.md) |
