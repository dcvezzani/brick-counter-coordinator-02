...
| 2026-06-16 | `new-counter-input-control` | Stepped swipe quantity input on lot form | [#83](https://github.com/dcvezzani/brick-counter-coordinator-02/issues/83) | `feature/new-counter-input-control` | [#85](https://github.com/dcvezzani/brick-counter-coordinator-02/pull/85) | [00-shipped/new-counter-input-control/validate-scorecard.md](00-shipped/new-counter-input-control/validate-scorecard.md) |
| 2026-06-16 | `button-sizes-are-inconsistent` | Consistent primary action button heights (marketing + ViewActions) | [#86](https://github.com/dcvezzani/brick-counter-coordinator-02/issues/86) | `feature/button-sizes-are-inconsistent` | [#87](https://github.com/dcvezzani/brick-counter-coordinator-02/pull/87) | [00-shipped/button-sizes-are-inconsistent/validate-scorecard.md](00-shipped/button-sizes-are-inconsistent/validate-scorecard.md) |
| 2026-06-16 | `new-session-use-filterable-picker` | Set search picker on New session (`SetSearchCombobox` + set catalog) | [#88](https://github.com/dcvezzani/brick-counter-coordinator-02/issues/88) | `feature/new-session-use-filterable-picker` | [#89](https://github.com/dcvezzani/brick-counter-coordinator-02/pull/89) | [00-shipped/new-session-use-filterable-picker/validate-scorecard.md](00-shipped/new-session-use-filterable-picker/validate-scorecard.md) |
...
| — | `new-counter-input-control` | Stepped swipe quantity on lot form | [#83](https://github.com/dcvezzani/brick-counter-coordinator-02/issues/83) — **Shipped** | Counting throughput |
...
3. ~~**ui-feedback-primitives**~~ — **Complete.** Toasts, `ConfirmDialog`, alert/skeleton baseline; export stub toast.
