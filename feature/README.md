...
| Slug | Status |
|------|--------|
| [button-sizes-are-inconsistent](./button-sizes-are-inconsistent/) | Design **approved** — ready for `/build` ([#86](https://github.com/dcvezzani/brick-counter-coordinator-02/issues/86)) |
