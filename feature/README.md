...
| Slug | Status |
|------|--------|
| [button-sizes-are-inconsistent](./button-sizes-are-inconsistent/) | Plan — draft awaiting approval ([#86](https://github.com/dcvezzani/brick-counter-coordinator-02/issues/86)) |
