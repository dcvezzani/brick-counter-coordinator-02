...
| **Related Tech Spec** | [tech-spec.md](tech-spec.md) — **Approved for build** · [blob](https://github.com/dcvezzani/brick-counter-coordinator-02/blob/feature/lot-entry-cockpit-lot-entry-cockpit-validate/feature/lot-entry-cockpit/sub-features/lot-entry-cockpit-validate/tech-spec.md) |
