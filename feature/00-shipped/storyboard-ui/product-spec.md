...
- Parent work item links to `feature/00-shipped/storyboard-ui/`.
...
| 2026-06-12 | Parent issue [#3](https://github.com/dcvezzani/brick-counter-coordinator-02/issues/3) created with link to `feature/00-shipped/storyboard-ui/`. |
...
- Prior feature: [feature/00-shipped/initial-setup/product-spec.md](../initial-setup/product-spec.md)
