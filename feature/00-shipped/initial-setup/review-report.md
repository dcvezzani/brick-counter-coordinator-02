...
2. **Default branch** — Repo default is still `feature/initial-setup` on GitHub; set to `main` after merge (repo hygiene, not PR code).
...
Per AIDLC [INTERACTIVE-UI-VALIDATION.md](../../../.claude/deps/ai-dlc/docs/INTERACTIVE-UI-VALIDATION.md), formal UI validation should use Chrome DevTools MCP.
