...
- Parent work item: [GitHub issue #1](https://github.com/dcvezzani/brick-counter-coordinator-02/issues/1) links to `feature/00-shipped/initial-setup/`.
...
| Date | Decision |
|------|----------|
| 2026-06-12 | Feature slug: `initial-setup`. Parent issue #1 created with link to `feature/00-shipped/initial-setup/`. |
